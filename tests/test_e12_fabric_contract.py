...
class E12FabricContractTests(unittest.TestCase):
    def test_portfolio_notebook_mirrors_ledger_and_derives_valuation(self):
        ...
        self.assertIn("fact_theme_membership", notebook)
        ...
        self.assertIn("priced_security_keys", notebook)
        self.assertIn('.join(priced_security_keys, "security_sk", "inner")', notebook)
        self.assertIn(".unionByName(portfolio_security_keys)", notebook)
